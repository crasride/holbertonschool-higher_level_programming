...
# Learning Objectives
At the end of this project, you are expected to be able to [explain](https://intranet.hbtn.io/rltoken/zZgUO7RfjW1JM66ZFq9EHA) to anyone, without the help of Google:
...
- Do not use the function `printè (with string format to display integers) more than 4 times
- You have to define:
...
You are not allowed to use `*` for importing or `_import_`
Your code should not be executed when imported
