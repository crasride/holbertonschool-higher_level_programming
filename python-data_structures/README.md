...
- [Data structures](https://intranet.hbtn.io/rltoken/89W42byWTSM4e25VSPKMRg) (until 5.3. Tuples and Sequences included)
- [Learn to Program 6 : Lists](https://intranet.hbtn.io/rltoken/JNLdadDW7IWjwW9dbcEyhg)

# Learning Objectives

At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/EKmHTirCHjvH-IXbBEzi8g), without the help of Google:
